         ...
         :<> {       
            question.length>=currentQuestion?
                <div className="flex flex-col">
                    ...
                    <h2>{currentQuestion}  / {quizLen[currentQuestion-1].all_question} </h2>
                    <h1 className="text-center p-2 text-xl block italic font-bold">{question[currentQuestion-1].question[lang]} </h1>
                    {options[currentQuestion-1].options[lang].map((option, i)=> (
                    ...
                    {currentQuestion<quizLen[currentQuestion-1].all_question ?
